namespace :db do
  ...
  task populate: :environment do
    ...
    product.product_attributes.create!(name: "birthday_kid", attr_type: "dt_picker", params: "{label: '出生日期及时间'}")
    ...
    product.product_attributes.create!(name: "father_birthday", attr_type: "dt_picker", params: "{label: '父亲出生日期及时间'}")
    product.product_attributes.create!(name: "mother_birthday", attr_type: "dt_picker", params: "{label: '母亲出生日期及时间'}")
    ...
    product.product_attributes.create!(name: "birthday_com", attr_type: "dt_picker", params: "{label: '公司创建日期'}")
    product.product_attributes.create!(name: "birthday_cli", attr_type: "dt_picker", params: "{label: '负责人出生日期及时间', hint: '如经理、法人代表、CEO等'}")
