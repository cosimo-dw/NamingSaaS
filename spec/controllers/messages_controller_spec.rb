  ...
  describe "create a new message" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved message as @message" do
        ...
        post :create, {:message => { "content" => "invalid value" }}, valid_session
        assigns(:message).should be_a_new(Message)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested message" do
        ...
        Message.any_instance.should_receive(:update).with({ "content" => "MyString" })
        put :update, {:id => message.to_param, :message => { "content" => "MyString" }}, valid_session
      end
